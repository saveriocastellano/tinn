...
class Shell : public i::AllStatic {
 public:
  ...
  static void InitJS(Isolate* isolate);
  ...
  static void ProcessCwd(const v8::FunctionCallbackInfo<v8::Value>& args);
  static void ProcessFileAndReadable(const v8::FunctionCallbackInfo<v8::Value>& args);
  ...
  static void AddTINNOS(Isolate* isolate, v8::Local<v8::Context> &context);
