    ...
    namespace spi
    {
        ...
        public:
         ...
         DECLARE_ABSTRACT_LOG4CXX_OBJECT(AppenderAttachable)
             ...
             * Add an appender.
             */
            virtual void addAppender(const helpers::AppenderPtr& newAppender) = 0;
             ...
             */
            virtual helpers::AppenderPtr getAppender(const LogString& name) const = 0;

            /**
         Returns <code>true</code> if the specified appender is in list of
         attached attached, <code>false</code> otherwise.
         */
         virtual bool isAttached(const helpers::AppenderPtr& appender) const = 0;
             ...
             */
            virtual void removeAppender(const helpers::AppenderPtr& appender) = 0;
