...
namespace log4cxx
{
    ...
    */
    ...
    public:
        ...
        */
        virtual void addAppender(const helpers::AppenderPtr& newAppender);
        ...
        */
        ...
        helpers::AppenderPtr getAppender(const LogString& name) const;
        ...
        */
        helpers::LoggerRepositoryPtr getLoggerRepository() const;
        ...
        */
        static LoggerPtr getLoggerLS(const LogString& name,
                        const helpers::LoggerFactoryPtr& factory);
        /**
        Like #getLogger except that the type of logger
        instantiated depends on the type returned by the
        LoggerFactory#makeNewLoggerInstance method of the
        ...
        */
        bool isAttached(const helpers::AppenderPtr& appender) const;
        ...
        */
        void removeAppender(const helpers::AppenderPtr& appender);
