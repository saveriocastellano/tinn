...
void Shell::ProcessFileAndReadable(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    ...
    v8::String::Utf8Value str(args.GetIsolate(), Local<String>::Cast(args[0]));

	args.GetReturnValue().Set(v8::Boolean::New(isolate,isFileReadable(*str)));
}
