...
//	virtual bool pipelinedRequest(const std::vector<std::string> &req);
//	virtual bool pipelineExec();
//	virtual void pipelineStart() ;
	virtual bool  pipelinedCommands(const std::vector<std::vector<std::string>> &req) ;
	...
	virtual Status getset(const std::string &key, const std::string &val, std::string *rval);
	virtual Status setnx(const std::string &key, const std::string &val, int64_t *ret);
	...
	virtual Status zremrangebyscore(const std::string &name, int64_t scoreMin, int64_t scoreMax, int64_t *ret) ;
	virtual Status zcount(const std::string &name, int64_t min, int64_t max, int64_t *ret) ;
	...
	virtual Status qlist(const std::string &name, const std::string &start, const std::string &end, int64_t limit, std::vector<std::string> *ret);
